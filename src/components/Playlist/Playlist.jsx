        ...
        {playlists.length > 0 ? (
          <ul className="space-y-4">
            {playlists.map(playlist => (
              <li
                key={playlist.id}
                className="flex items-center space-x-4 p-3 bg-gray-800 rounded-lg hover:bg-gray-700 cursor-pointer transition-colors"
                ...
                >
                  ...
                  {playingTrackId === item.track.id ? (
                    <button
                      ...
                      className="text-white bg-[#1DB954] hover:bg-[#2e6a33] px-3 py-1 rounded"
                    >
                      Pause
                    </button>
                  ) : (
                    <button className="text-white bg-[#1DB954] hover:bg-[#2e6a33] px-3 py-1 rounded">
                      Play Preview
                    </button>
                  )}
                </li>
